          ...
          >
            <p className="text-white text-justify lg:text-lg">
              {locale === "en"
                ...
                : "Saya adalah seorang Full Stack Web Developer (Frontend & Backend) berusia 21 tahun yang tinggal di Depok, dengan spesialisasi dalam pengembangan web modern. Berbekal pengalaman profesional lebih dari satu tahun serta latar belakang pendidikan di Teknik Informatika dari Politeknik Negeri Jakarta dan CCIT Universitas Indonesia, saya menguasai teknologi web modern, pemikiran kritis, inisiatif, pembelajaran cepat, pemecahan masalah, kerja tim, dan kepemimpinan. Saya berkomitmen untuk menciptakan perangkat lunak berkualitas tinggi dan memberikan kontribusi yang berarti dalam setiap proyek yang saya kerjakan."}
            </p>
          </div>
        </div>
      </div>
